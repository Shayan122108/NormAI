...
> - **[docker-compose-speaches.yml](../../examples/docker-compose-speaches.yml)** - Speaches + Custom RAG Pipeline
...
### Step 4: Configure Custom RAG Pipeline
...
```yaml
# In your Custom RAG Pipeline docker-compose.yml
environment:
...
### Step 5: Add Model in Custom RAG Pipeline
...
### Custom RAG Pipeline in Docker (macOS/Windows)

**STT Base URL:** `http://host.docker.internal:8969/v1`

### Custom RAG Pipeline in Docker (Linux)
...
# From inside Custom RAG Pipeline container
docker exec -it rag-backend curl http://host.docker.internal:8969/v1/models
```
