...
Custom RAG Pipeline uses SurrealDB for its database needs. 

---

## Default Configuration

Custom RAG Pipeline should work out of the box with SurrealDB as long as the environment variables are correctly setup. 


### DB running in the same docker compose as Custom RAG Pipeline (recommended)
...
### DB running in the host machine and Custom RAG Pipeline running in Docker
...
### Custom RAG Pipeline and Surreal are running on the same machine
