...
Configuration is how you customize Custom RAG Pipeline for your specific setup. This section covers what you need to know.
...
You will only use .env if you are running Custom RAG Pipeline locally.
...
1. Set `rag_backend_ENCRYPTION_KEY` in your environment (required for storing credentials)
2. Start services
...
```
1. Open Custom RAG Pipeline in your browser
...
2. Set rag_backend_ENCRYPTION_KEY and database vars
3. Save
4. Restart services
```
...
| Missing encryption key | Can't save credentials | Set rag_backend_ENCRYPTION_KEY |
...
1. Set `rag_backend_ENCRYPTION_KEY` in your environment
2. Start services
