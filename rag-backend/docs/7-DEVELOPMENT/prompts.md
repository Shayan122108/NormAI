...
Mechanical rules (path syntax, `data=` key matching, parser injection, no inheritance, cache → restart) are in [`rag_backend/AGENTS.md`](../../rag_backend/AGENTS.md). This page covers the *patterns*.
