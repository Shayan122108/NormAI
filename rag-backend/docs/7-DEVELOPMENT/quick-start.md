...
Get Custom RAG Pipeline running locally in 5 minutes.
...
git clone https://github.com/YOUR_USERNAME/rag-backend.git
cd rag-backend
...
- **Frontend**: http://localhost:3000 → Custom RAG Pipeline UI
...
- **First Issue?** Pick a [good first issue](https://github.com/lfnovo/rag-backend/issues?q=label%3A%22good+first+issue%22)
