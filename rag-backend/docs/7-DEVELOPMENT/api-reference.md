...
Complete REST API for Custom RAG Pipeline. All endpoints are served from the API backend (default: `http://localhost:5055`).
...
Password configured via `rag_backend_PASSWORD` environment variable.
