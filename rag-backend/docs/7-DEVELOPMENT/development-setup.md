...
This guide walks you through setting up Custom RAG Pipeline for local development. Follow these steps to get the full stack running on your machine.
...
git remote add upstream https://github.com/lfnovo/rag-backend.git
```
...
rag_backend_ENCRYPTION_KEY=my-dev-secret-key

# Application
rag_backend_PASSWORD=  # Optional password protection
DEBUG=true
LOG_LEVEL=DEBUG
```
...
uv run pytest --cov=rag_backend --cov-report=html
```
