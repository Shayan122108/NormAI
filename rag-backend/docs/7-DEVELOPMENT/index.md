...
Welcome to the Custom RAG Pipeline development documentation! Whether you're contributing code, understanding our architecture, or maintaining the project, you'll find guidance here.
...
repo root, `rag_backend/`, and `frontend/`.
