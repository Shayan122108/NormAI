# Custom RAG Pipeline Documentation

Welcome to Custom RAG Pipeline - a privacy-focused AI research assistant. This documentation is organized for different needs.
...
- Learn what Custom RAG Pipeline is
...
**Result:** Fully understand how to use Custom RAG Pipeline
...
- **GitHub Issues** — https://github.com/lfnovo/rag-backend/issues
...
**First time using Custom RAG Pipeline?**
...
Last updated: January 2026 | Custom RAG Pipeline v1.2.4+
