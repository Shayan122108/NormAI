...
Before diving into how to use Custom RAG Pipeline, it's important to understand **how it thinks**. These core concepts explain the "why" behind the design.

## The Five Mental Models

### 1. [Notebooks, Sources, and Notes](notebooks-sources-notes.md)
How Custom RAG Pipeline organizes your research. Understand the three-tier container structure and how information flows from raw materials to finished insights.
...
How Custom RAG Pipeline makes AI aware of your research - two different approaches.
...
Why Custom RAG Pipeline has different interaction modes and when to use each one.
...
Why Custom RAG Pipeline can turn research into audio and why this matters.
...
- **You're new to Custom RAG Pipeline** — Start here to understand how the system works conceptually before learning the features
...
Custom RAG Pipeline is built on a simple insight: **Your research deserves to stay yours**.
