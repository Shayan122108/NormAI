...
Common questions about Custom RAG Pipeline usage, configuration, and best practices.

---

## General Usage

### What is Custom RAG Pipeline?

Custom RAG Pipeline is an open-source, privacy-focused alternative to Google's Notebook LM. It allows you to:
...
### Can I use Custom RAG Pipeline offline?
...
- Use `rag_backend_PASSWORD` for public deployments
...
### Can I use Custom RAG Pipeline programmatically?

**Yes**: Custom RAG Pipeline provides a REST API:
- Full API documentation at `http://localhost:5055/docs`
- Support for all UI functionality
- Authentication via password header

### Can I run Custom RAG Pipeline in production?
...
3. Ask in [GitHub Discussions](https://github.com/lfnovo/rag-backend/discussions/categories/q-a) or the Discord community
...
Submit to: [GitHub Issues](https://github.com/lfnovo/rag-backend/issues)
