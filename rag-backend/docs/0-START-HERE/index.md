# Custom RAG Pipeline - Start Here

**Custom RAG Pipeline** is a privacy-focused AI research assistant. Upload documents, chat with AI, generate notes, and create podcasts—all with complete control over your data.
...
## Why Custom RAG Pipeline?

| Feature | Custom RAG Pipeline | Notebook LM |
|---------|---|---|
