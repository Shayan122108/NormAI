...
A flexible and generic ContextBuilder class for the Custom RAG Pipeline project that can handle any parameters and build context from sources, notebooks, insights, and notes.
...
```python
from rag_backend.utils.context_builder import ContextBuilder, ContextConfig
...
```python
from rag_backend.utils.context_builder import (
...
```python
from rag_backend.utils.context_builder import ContextConfig
...
```python
from rag_backend.utils.context_builder import ContextItem
...
The ContextBuilder integrates seamlessly with the existing Custom RAG Pipeline architecture:
