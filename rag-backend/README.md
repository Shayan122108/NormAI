...
<br />
<div align="center">
  <a href="https://github.com/lfnovo/rag-backend">
    <img src="docs/assets/hero.svg" alt="Logo">
  </a>

  <h3 align="center">Custom RAG Pipeline — Knowledge Base Engine</h3>

  <p align="center">
    A self-hosted, privacy-focused Custom RAG Pipeline and knowledge base engine for AI applications.
    <br /><strong>Join our <a href="https://discord.gg/37XJPXfz2w">Discord server</a> for help, to share workflow ideas, and suggest features!</strong>
    <br />
    <a href="https://www.rag-backend.ai"><strong>Checkout our website »</strong></a>
    <br />
...
<p align="center">
<a href="https://trendshift.io/repositories/14536" target="_blank"><img src="https://trendshift.io/api/badge/repositories/14536" alt="lfnovo%2Frag-backend | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>
</p>

<div align="center">
  <!-- Keep these links. Translations will automatically update with the README. -->
  <a href="https://zdoc.app/de/lfnovo/rag-backend">Deutsch</a> | 
  <a href="https://zdoc.app/es/lfnovo/rag-backend">Español</a> | 
  <a href="https://zdoc.app/fr/lfnovo/rag-backend">français</a> | 
  <a href="https://zdoc.app/ja/lfnovo/rag-backend">日本語</a> | 
  <a href="https://zdoc.app/ko/lfnovo/rag-backend">한국어</a> | 
  <a href="https://zdoc.app/pt/lfnovo/rag-backend">Português</a> | 
  <a href="https://zdoc.app/ru/lfnovo/rag-backend">Русский</a> | 
  <a href="https://zdoc.app/zh/lfnovo/rag-backend">中文</a>
</div>

## A private, multi-model, 100% local, full-featured Custom RAG Pipeline

![New Knowledge Base](docs/assets/asset_list.png)

In a world dominated by Artificial Intelligence, having the ability to think 🧠 and acquire new knowledge 💡, is a skill that should not be a privilege for a few, nor restricted to a single provider.

**Custom RAG Pipeline empowers you to:**
...
Learn more about our project at [https://www.rag-backend.ai](https://www.rag-backend.ai)

---

## 🆚 Custom RAG Pipeline vs Google Notebook LM

| Feature | Custom RAG Pipeline | Google Notebook LM | Advantage |
|---------|---------------|--------------------|-----------|
...
**Why Choose Custom RAG Pipeline?**
...
```bash
curl -o docker-compose.yml https://raw.githubusercontent.com/lfnovo/rag-backend/main/docker-compose.yml
```
...
services:
  surrealdb:
    ...
    # rag_backend service below, so the two always stay in sync.
    ...
    ports:
      # Bound to localhost only: the rag_backend service reaches this over
  ...
  rag_backend:
    image: lfnovo/rag_backend:v1-latest
    ports:
      - "8502:8502"  # Web UI
      - "5055:5055"  # REST API
    environment:
      ...
      - rag_backend_ENCRYPTION_KEY=change-me-to-a-secret-string
      ...
      - SURREAL_NAMESPACE=rag_backend
      - SURREAL_DATABASE=rag_backend
    volumes:
...
- **🤖 AI Installation Assistant**: [CustomGPT to help you install](https://chatgpt.com/g/g-68776e2765b48191bd1bae3f30212631-rag-backend-installation-assistant)
...
- **🐛 Report Issues**: [GitHub Issues](https://github.com/lfnovo/rag-backend/issues)

---

## Star History

[![Star History Chart](https://star-history.dera.page/svg?repos=lfnovo/rag-backend&type=date&legend=top-left)](https://star-history.dera.page/#lfnovo/rag-backend&type=date&legend=top-left)
...
### Getting Started
- **[📖 Introduction](docs/0-START-HERE/index.md)** - Learn what Custom RAG Pipeline offers
...
- **[🧭 Vision & Principles](VISION.md)** - What Custom RAG Pipeline is, and where it's going
...
Explore [GitHub Discussions](https://github.com/lfnovo/rag-backend/discussions/categories/ideas) for proposed features and product ideas, and [open Issues](https://github.com/lfnovo/rag-backend/issues) for known bugs and approved work.

<p align="right">(<a href="#readme-top">back to top</a>)</p>


## 📖 Need Help?
- **🤖 AI Installation Assistant**: We have a [CustomGPT built to help you install Custom RAG Pipeline](https://chatgpt.com/g/g-68776e2765b48191bd1bae3f30212631-rag-backend-installation-assistant) - it will guide you through each step!
- **New to Custom RAG Pipeline?** Start with our [Getting Started Guide](docs/0-START-HERE/index.md)
...
- 💡 **[GitHub Discussions](https://github.com/lfnovo/rag-backend/discussions)** - Ask questions and shape features, product direction, design, and architecture
- 🐛 **[GitHub Issues](https://github.com/lfnovo/rag-backend/issues)** - Report reproducible bugs and find approved work
- ⭐ **Star this repo** - Show your support and help others discover Custom RAG Pipeline

### Contributing
We welcome contributions! We're especially looking for help with:
- **Frontend Development**: Help improve our modern Next.js/React UI
- **Testing & Bug Fixes**: Make Custom RAG Pipeline more robust
...
Custom RAG Pipeline is MIT licensed. See the [LICENSE](LICENSE) file for details.


**Community Support**:
- 💬 [Discord Server](https://discord.gg/37XJPXfz2w) - Get help, share ideas, and connect with users
- 𝕏 [Follow @lfnovo on X](https://x.com/lfnovo) - Project updates and news from the maintainer
- 💡 [GitHub Discussions](https://github.com/lfnovo/rag-backend/discussions) - Ask questions and shape ideas
- 🐛 [GitHub Issues](https://github.com/lfnovo/rag-backend/issues) - Report reproducible bugs and find approved work
- 🌐 [Website](https://www.rag-backend.ai) - Learn more about the project
...
[contributors-shield]: https://img.shields.io/github/contributors/lfnovo/rag-backend.svg?style=for-the-badge
[contributors-url]: https://github.com/lfnovo/rag-backend/graphs/contributors
[forks-shield]: https://img.shields.io/github/forks/lfnovo/rag-backend.svg?style=for-the-badge
[forks-url]: https://github.com/lfnovo/rag-backend/network/members
[stars-shield]: https://img.shields.io/github/stars/lfnovo/rag-backend.svg?style=for-the-badge
[stars-url]: https://github.com/lfnovo/rag-backend/stargazers
[issues-shield]: https://img.shields.io/github/issues/lfnovo/rag-backend.svg?style=for-the-badge
[issues-url]: https://github.com/lfnovo/rag-backend/issues
[license-shield]: https://img.shields.io/github/license/lfnovo/rag-backend.svg?style=for-the-badge
[license-url]: https://github.com/lfnovo/rag-backend/blob/master/LICENSE.txt
