...
([Discussion #1266](https://github.com/lfnovo/rag-backend/discussions/1266)
is the public essay; [#1212](https://github.com/lfnovo/rag-backend/discussions/1212)
...
{ repository(owner: "lfnovo", name: "rag-backend") {
...
Repo id: `R_kgDONDsQ1w`. These are GitHub GraphQL node ids for lfnovo/rag-backend;
they change if a category is recreated or the skill is used on a fork. Regenerate:

```bash
gh api graphql -f query='{ repository(owner: "lfnovo", name: "rag-backend") {
