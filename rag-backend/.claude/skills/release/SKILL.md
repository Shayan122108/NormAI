---
name: release
description: Orchestrate an Custom RAG Pipeline release — changelog audit, risk-based A/B/C test matrix, Docker image gate (fresh + upgrade), fix loop via PRs, cut, publication with credits, retro. Use when preparing, testing, cutting or publishing a release.
---

# Custom RAG Pipeline Release Orchestrator

You are conducting a release of Custom RAG Pipeline, reproducing the process
