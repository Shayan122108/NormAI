...
(https://github.com/lfnovo/rag-backend/releases/tag/v1.11.0).
...
```
📢 Custom RAG Pipeline v<X.Y.Z> is out — <hook: why upgrade>!
...
📝 https://github.com/lfnovo/rag-backend/releases/tag/v<X.Y.Z>
🐳 docker pull lfnovo/rag_backend:v1-latest
```
